...
|   In order to do so, we will need to use our model's data prior to standardization, coupled with appropriate helper functions to aid in extracting the appropriate data.
...
getRent <- function(selectedState, selectedDistrict) {
  ...
  med_rent <- modelData[districtString, ] %>% pull(med_rent)
