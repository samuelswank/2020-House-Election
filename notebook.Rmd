...
|   As of the 2016 congressional race, **`r sprintf("%s District %s", strsplit(d1, split = " ")[[1]][1], strsplit(d1, split = " ")[[1]][2])`** ranked 17 highest in population density, with **`r sprintf("%s District %s", strsplit(r1, split = " ")[[1]][1], strsplit(r1, split = " ")[[1]][2])`** lower, in the 130th place.
...
|   Examining the above chart the reader can see that the Utah District has been held by a roughly equal number of times by Democrat and Republican candidates. The reader will see that Utah voters, though conservative, have been more pragmatic than ideological regarding their choice of candidate. During the period comprising the 107th through 113th congresses, the Utah 2nd and later 4th congressional district was held by Democrat James Matheson, son of Scott Matheson, Utah's most recent Democratic Governor. As governor, the senior Matheson was known for a number of bipartisan and conservative decisions, including choosing a Republican, David Monson, as his Lieutenant Governor, and upholding state restrictions on abortion. The younger Matheson, likewise, supported a continued American presence in the Iraq war in 2008 when many in his party were calling for withdrawal, and he opposed the Affordable Care Act. This focus on policy would also explain why Ben McAdams, the last Democrat to hold the seat at the time of this writing, lost re-election. A successful campaign by Republicans demonstrating that McAdams had allowed local taxes to go up when he was serving as Salt Lake County Mayor, contributed to McAdams' and the Democrats' loss of Utah's 4th District. This history of Utah's urban district demonstrates. It would seem that the concrete effects a given policy decision has on constituents is the ultimate long-term determinant as to who will be elected. Demographics may influence policy preferences, but experience ultimately wins out in the end.

\  

|   The case of California District 21 is somewhat curious. Even accounting for redistricting, the loss of much of Fresno shifted the district from Democrat to Republican. In fact Democrat James Costa who held the seat at the time of its last redistricting reran for the California District 16 seat and, at the time of this writing, is still the incumbent there. Though Republican **David Valadão**'s views on most issues ranging from the environment, to social welfare, to homosexuality, he was ranked the 42nd most bipartisan member of congress according to the Lugar Center's Bipartisan Index. It would seem a reasonable, albeit unconfirmed, hypothesis that members of congress occupying seats which *flip party* more frequently would be likely to score higher on the Bipartisan Index. From this we can infer that the constituencies of these districts likely have a more varied range of interest groups compared to those districts which tend to consistently vote for candidates from a single party. Many of these interest groups lie outside of the realm of the demographics discussed here. Investigation of which interest groups do contribute to the flipped districts presents a fertile fild for further study.
...
|   Observing the map of **South Carolina**, we find yet another district which fits the bill. Only the part containing Charleston is urban, a possible indication as to why the Republicans have had an easier time holding the seat compared to other places discussed herein. It should also be noted that the state's **6th Congressional District** contains **Richland**, the states most populous county and has been *Democrat-held* since before the 1994 exodus of the South's Conservative Democrats.
...
|   **Utah's 4th Congressional District** contains much of Salt Lake County and the state's two most populous cities, Salt Lake City and West Valley City. Salt Lake and Summit Counties are the only two counties in the where the majority of voters cast their popular ballots against Donald Trump in 2015 and 2019. Fortunately for *Republicans* and those born in the state, the latter county has been effectively Gerrymandered out of a candidate in the House of Representatives.